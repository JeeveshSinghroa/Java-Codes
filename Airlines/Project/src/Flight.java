...
public class Flight extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String query="insert into flight(fname,dtime,atime,seatnum,dcity,ocity,fare) values(?,?,?,?,?,?,?)";
      ...
      try{
        ...
        /* ResultSet rs=st.getGeneratedKeys();
          int fnum;
        if (rs.next()) {
            fnum = (int) rs.getInt(1);
            fnumber=String.valueOf(fnum);
            
        }
            jTextField1.setText(fnumber);*/
        st.close();   
        con.close();
