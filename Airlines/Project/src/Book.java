...
String fnum;
    ...
    rseat=Integer.toString(seats-number);
    int fare=Integer.parseInt(jTextField6.getText());
    String amount=Integer.toString(number*fare);
    Confirm c= new Confirm();
        Confirm.jTextField1.setText(amount);
        Confirm.jTextField2.setText(rseat);
        fnum=jTextField1.getText();
        Confirm.jTextField3.setText(fnum);
         Confirm.jTextField4.setText(Integer.toString(number));
        c.setVisible(true);
