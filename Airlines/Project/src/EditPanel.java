...
String  fname,dtime,atime,dcity,ocity;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(F_num, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel1)
                    .addComponent(F_num, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String fnum=F_num.getText();
        String ffnum=String.valueOf(fnum);
        String query="delete from flight where fnumber=?";
        String query1="insert into flight(fnumber,fname,dtime,atime,seatnum,dcity,ocity,fare) values(?,?,?,?,?,?,?,?)";
        
        try{
            Class.forName("com.mysql.jdbc.Driver");
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/flight","root", "sakshi@123");
             PreparedStatement st1=con.prepareStatement(query);
             st1.setString(1, ffnum);
             st1.execute();
            ...
            st.setString(1, ffnum);
            st.setString(2,fname);
            st.setString(3,dtime);
            st.setString(4,atime);
            st.setInt(5,seatnum);
            st.setString(6,dcity);
            st.setString(7,ocity);
            st.setInt(8,fare);
            st.executeUpdate();
            this.dispose();
    ...
    public static javax.swing.JTextField F_num;
